...
describe("Add new dripping schedule for Op", async () => {
    before(async () => {
    ...
    it("Validate results", async () => {
        ...
        const schedule = await treasury.tokenSchedules(addresses.newOpConnectorAddr);
        console.log({schedule});
        schedule["target"].should.eq(addresses.newOpConnectorAddr);
